...
import {
  ...
  getStops, createStop, updateStop, deleteStop, longLegPreview, recheckLegs, makeOneWay,
...
// FIX-MODIFY-SWAP-RECHECK — explicit Plan-is-Truth recheck, used by the Modify
// panel after a deferred-recheck remove whose paired add_stop didn't land.
tripsRouter.post('/:id/recheck-legs', recheckLegs as any)
