            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
              {VEHICLE_OPTIONS.map(v => (
                <button
                  ...
                  className={`flex items-center gap-3 p-3 rounded-xl border text-left hover:border-[#1D9E75] transition-colors ${
                    vehicleType === v.type ? 'border-[#1D9E75] bg-[#E1F5EE]' : 'border-gray-200 bg-white'
                  }`}
