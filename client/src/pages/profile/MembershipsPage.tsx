    ...
    <div className="space-y-4 max-w-2xl">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
        {MEMBERSHIP_TYPES.map(type => {
          ...
          return (
            <div key={type.id} className={`card flex items-start justify-between ${active ? 'border-[#1D9E75]/30' : ''}`}>
              ...
              {active && membership && (
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className={`text-xs px-2 py-1 rounded ${membership.autoApply ? 'text-[#1D9E75]' : 'text-gray-400'}`}
                  >
