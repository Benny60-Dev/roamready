...
export const OHV_STATE_RESOURCES: OhvStateResource[] = [
  ...
  { state: 'Kansas', abbr: 'KS', agency: 'Kansas Dept of Wildlife & Parks — ATV/Off-Road', url: 'https://ksoutdoors.gov/Outdoor-Activities/ATV-AND-OFF-ROAD-VEHICLES', type: 'state-program', confidence: 'medium' },
