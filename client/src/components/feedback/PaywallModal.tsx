    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/30">
      <div className="bg-white rounded-xl border border-gray-200 w-full max-w-lg p-6" style={{ borderWidth: '0.5px' }}>
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 bg-[#E1F5EE] rounded-lg flex items-center justify-center">
              <Zap size={16} className="text-[#1D9E75]" />
            </div>
            <div>
        ...
        <div className="grid grid-cols-2 gap-3 mb-6">
          <div className="border border-[#1D9E75] rounded-xl p-4" style={{ borderWidth: '0.5px' }}>
            <div className="text-sm font-medium text-[#1D9E75] mb-1">Pro</div>
